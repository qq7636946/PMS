...
import { User, Lock, Bell, Shield, Save, Camera, Trash2, AlertCircle, Loader2, Database, RotateCcw, ListChecks, Plus, X, GripVertical } from 'lucide-react';
...
export const SettingsView: React.FC<SettingsViewProps> = ({ currentUser, onUpdateProfile, onResetData, defaultStages = [], onUpdateDefaultStages }) => {
                ...
                <div className="md:col-span-1 space-y-6">
                    <div className="bento-card p-6 md:p-8 flex flex-col items-center text-center relative overflow-hidden bg-white dark:bg-[#18181b] border border-slate-100 dark:border-zinc-800">
                        ...
                        <span className={`px-4 py-1.5 rounded-full text-xs font-bold border flex items-center gap-2 ${
                            currentUser.accessLevel === 'Admin' ? 'bg-rose-50 dark:bg-rose-500/20 text-rose-600 dark:text-rose-500 border-rose-100 dark:border-rose-900' :
